              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Hãy nhập mật khẩu mới của bạn</p>
                  </div>
                  ...
                  <!-- Form đăng nhập -->
                  <form class="row g-3 needs-validation" method="POST" action="AuthController.php?action=reset_password&token=<?= htmlspecialchars($token) ?>">
                  <div class="col-12">
                        <label for="new_password" class="form-label">Mật khẩu mới</label>
                        <input type="password" name="new_password" class="form-control" id="new_password" required>
                    </div>
                    <div class="col-12">
                        <label for="renew_password" class="form-label">Nhập lại mật khẩu mới</label>
