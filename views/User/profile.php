...
$bootstrapPath = __DIR__ . "../../Admin/bootstrap/";
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        <img src="../../assets/img/avatar1.jpeg" alt="Profile" class="rounded-circle">
                ...
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link <?= ($activeTab === 'profile-settings') ? 'active' : '' ?>" data-bs-toggle="tab" data-bs-target="#profile-settings">Settings</button>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content pt-2">
                            <div class="profile-overview tab-pane fade <?= ($activeTab === 'profile-overview') ? 'show active' : '' ?>" id="profile-overview">
                            ...
                            <div class="tab-pane fade <?= ($activeTab === 'profile-edit') ? 'show active' : '' ?>" id="profile-edit">
                                <!-- Profile Edit Form -->
                                <form>
                                    <div class="row mb-3">
                                        <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                                        <div class="col-md-8 col-lg-9">
                                            <img src="../../assets/img/avatar1.jpeg" alt="Profile">
                                            <div class="pt-2">
                            ...
                            <div class="tab-pane fade <?= ($activeTab === 'profile-settings') ? 'show active' : '' ?>" id="profile-settings">
                                <!-- Settings Form -->
                                <form>
                                    <div class="row mb-3">
                            ...
                            <div class="tab-pane fade <?= ($activeTab === 'profile-change-password') ? 'show active' : '' ?> pt-3" id="profile-change-password">
                                ...
                                <form method="POST" action="userController.php?action=change_password">
